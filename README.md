...
├── contextual-bandit-fixes-validation.tgz  # Scenario C fixes validated + lin_ts head-to-head (2026-07)
...
│   ├── contextual-bandit-fixes-validation/  # Post-fix re-run + lin_ts comparison
